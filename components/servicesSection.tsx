      ...
      >
        <div className="mb-[1vh] m-auto">
          <h1 className="h1 mainh1 text-black">
            <span className="text-[#7C6C77] text-[32px] leading-[3]">Consultoría empresarial</span>
          </h1>
        </div>
        <div>
          <p className=" uppercase font-semibold text-black text-[17px] leading-[4vh]">
            ...
            estrategia IA coherente y práctica, cuidadosamente adaptada según
