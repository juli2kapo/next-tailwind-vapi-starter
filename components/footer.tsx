            ...
            <div className="footer-right-div-top-div horizontal-div columnifmedia">
                <div>
                    <div className="horizontal-div flex items-center space-x-2">
                        ...
                        <div className="footer-text text-white">Ubicación</div>
                    </div>
                    <div className="footer-text text-[#7C6C77] mt-1">Buenos Aires, Argentina</div>
                </div>
                <div className="div-block-5">
                    <div className="horizontal-div flex items-center mb-1 space-x-2">
                        ...
                        <div className="footer-text text-white">Contacto</div>
                    </div>
                    <a href="mailto:info@elykia.com.ar?subject=Asunto" className="footer-text text-[#7C6C77]">
                        info@elykia.com.ar
                    </a>
                </div>
            </div>
